...
export const managedAndSaas: DynatraceAccount = {
  id: 'managed-and-saas-account',
  name: 'Managed & SaaS',
  consumption: [],
...
managedAndSaas.children = [managed, saas];
...
export const managedAndSaasGrants: Grant[] = [
  {
...
export const managedAndSaasAllocs: AllocItem[] = [
  // {
  //   from: Date.UTC(2021, 0, 1),
  //   to: Date.UTC(2022, 5, 30),
